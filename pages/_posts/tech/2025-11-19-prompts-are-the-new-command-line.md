...
1.  **Requirements Analysis**: Turning vague client desires into concrete technical specs.
2.  **System Design**: Architecting scalable and maintainable systems.
3.  **Code Implementation**: Generating clean, idiomatic, and secure code.
4.  **Test Generation**: Ensuring reliability through comprehensive test coverage.
5.  **Documentation**: Creating clear, maintainable, and useful documentation.
6.  **Refactoring**: Improving code quality and performance without changing behavior.
7.  **Debugging**: Rapidly identifying and resolving complex issues.
