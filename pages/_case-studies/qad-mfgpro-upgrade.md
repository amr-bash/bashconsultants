---
title: "From Mfg/Pro to QAD Enterprise Edition without losing data"
description: How a manufacturer moved from QAD Mfg/Pro to Enterprise Edition with data validated before go-live and finance staff trained on day one
...
keywords:
  - QAD Enterprise Edition upgrade
  - Mfg/Pro migration
  - ERP version upgrade
  - ERP data migration
...
If you're a Colorado manufacturer sitting on an old ERP version — Mfg/Pro, an early SyteLine, or similar — the risk isn't just missing features. It's running your operation on software the vendor is winding down support for, with fewer people who know it each year. [QAD's own product documentation](https://www.qad.com/solutions) describes where the platform has gone; the upgrade path is well-trodden and typically runs a few months for a single-site business, not years.
